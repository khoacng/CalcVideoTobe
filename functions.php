	...
	function maxres_youtube($video, $thumbarray = false) {
		if (is_array($video) || $thumbarray) {
			...
			if (!is_array($thumbarray)) {
				$thumbs_array = $content['snippet']['thumbnails'];
			} else {
				$thumbs_array = $thumbarray;
			}
            $all_qualities = array();
            if (array_key_exists('maxres', $thumbs_array)) {
                array_push($all_qualities, $thumbs_array['maxres']);
            }
            if (array_key_exists('standard', $thumbs_array)) {
                array_push($all_qualities, $thumbs_array['standard']);
            }
            if (array_key_exists('high', $thumbs_array)) {
                array_push($all_qualities, $thumbs_array['high']);
            }
            if (array_key_exists('medium', $thumbs_array)) {
                array_push($all_qualities, $thumbs_array['medium']);
            }
            if (array_key_exists('default', $thumbs_array)) {
                array_push($all_qualities, $thumbs_array['default']);
            }
